...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 10. Jan 2015 um 14:36
...
(4, 'Der Hobbit', 3, 4, '120', 4, 3, '2015-01-06', '2015-01-01', 4, 2, 12.99),
...
--
ALTER TABLE `directors`
MODIFY `directors_ID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
